...
font = ('times', 15, 'bold')
title = Label(main, text='Drug Recommendation System based on Sentiment Analysis of Drug Reviews using Machine Learning')
...
preprocessButton = TkinterCustomButton(text="Read & Preprocess Dataset", width=300, corner_radius=5, command=preprocessDataset)
...
trainMLButton = TkinterCustomButton(text="Train Machine Learning Algorithms", width=300, corner_radius=5, command=TrainML)
